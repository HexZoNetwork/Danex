...
static void handle_client(int fd, std::string remote_ip) {
    ...
    if (req.path == "/page" && (req.method == "GET" || req.method == "HEAD")) {
        ...
        std::string html =
            ...
            "@media(max-width:680px){body{padding:10px!important;align-items:center}.card{max-height:calc(100vh - 20px)!important;min-height:0!important}.head{grid-template-columns:auto 1fr!important}.sub{grid-column:1/-1;justify-self:start;white-space:normal}.telemetry{grid-template-columns:1fr}.connbox{min-height:300px!important}.timer{font-size:32px!important}.human-wrap{left:14px!important;right:14px!important;bottom:14px!important}#human_btn{width:100%!important}.title{font-size:18px!important}.pat{padding:10px!important}.pat canvas{width:min(100%,320px)!important}}"
            ...
            "<div class=\"body\"><div class=\"telemetry\"><span class=\"metric\">Binding<b>IP + UA</b></span><span class=\"metric\">Runtime<b>Proof Active</b></span><span class=\"metric\">Mode<b>Interactive</b></span></div><div class=\"tabs\"><div class=\"tab on\" id=\"tab_conn\">Connection</div><div class=\"tab\" id=\"tab_chal\">Challenge</div></div>"
