...
function inverse($content, $col){
    ...
    return <<<HTML
    <button type="submit" onclick="setCont('$safeContent'); return is_turn();" name="card" style="--uno-card-color: $safeColor;" class="du-uno-card div_war9a_inverse du-uno-card-action" aria-label="Play $safeContent">
