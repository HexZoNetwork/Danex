 ...
 * @property \Illuminate\Support\Carbon|null $madeinweb_panel_created_at
    ...
    Identifiable
{
    ...
    protected $casts = [
        ...
        'madeinweb_panel_created_at' => 'datetime',
    ];
    ...
    public static array $validationRules = [
        ...
        'root_admin' => 'boolean',
        'language' => 'string',
        'telegram_id' => 'nullable|string|between:3,64',
        'madeinweb_panel_created_at' => 'nullable|date',
        'use_totp' => 'boolean',
