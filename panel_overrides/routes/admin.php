...
use Pterodactyl\Http\Middleware\Security\PteroProtectRestrictedAdmin;

Route::middleware([PteroProtectRestrictedAdmin::class])->group(function () {
    ...
    Route::group(['prefix' => 'protect'], function () {
        ...
        Route::post('/quarantine/rename', [Admin\ProtectController::class, 'quarantineRename'])->name('admin.protect.quarantine.rename');
        Route::post('/quarantine/delete', [Admin\ProtectController::class, 'quarantineDelete'])->name('admin.protect.quarantine.delete');
