...
static void handle_client(int fd, std::string remote_ip) {
    ...
    if (req.path == "/page" && (req.method == "GET" || req.method == "HEAD")) {
        ...
        std::string html =
            ...
            "function lockChallengeUI(){uiLocked=true;hardOpened=true;enteredChallenge=true;humanReady=true;try{sessionStorage.setItem('pp_chal_opened','1');}catch(_e){}showChal();}"
