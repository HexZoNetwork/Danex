...
static void handle_client(int fd, std::string remote_ip) {
    ...
    if (req.path == "/page" && (req.method == "GET" || req.method == "HEAD")) {
        ...
        std::string html =
            ...
            "background:var(--bg)}"
            ".card{width:min(840px,98vw);background:var(--card);"
            "border:1px solid var(--line);border-radius:var(--radius,12px);box-shadow:0 24px 64px rgba(0,0,0,.48);overflow-y:auto;max-height:98vh}"
            ...
            ".tab.on{color:#fff;background:var(--acc);border-color:rgba(255,255,255,.18);box-shadow:0 8px 20px rgba(76,29,149,.22)}.pane{display:none}.pane.on{display:block}.big{padding:16px;border:1px solid rgba(139,92,246,.24);border-radius:13px;background:#0b0b10}"
            ...
            "button{cursor:pointer;background:var(--acc);border-color:rgba(255,255,255,.18);font-weight:800;min-width:118px;box-shadow:0 8px 20px rgba(76,29,149,.24);transition:transform .16s ease,box-shadow .16s ease}"
            "#human_btn{width:200px;min-height:34px;font-size:12px;padding:8px 12px;letter-spacing:.1px;box-shadow:0 8px 20px rgba(76,29,149,.24)}"
            "button.secondary{background:#0b0b10;border-color:rgba(139,92,246,.34);color:#d8d8e8}"
            "button:hover{transform:translateY(-1px);box-shadow:0 10px 24px rgba(76,29,149,.32)}button:disabled{opacity:.66;cursor:not-allowed;transform:none}"
            ...
            "html,body{height:100%;overflow:hidden}body{position:relative;display:grid;place-items:center;background:#07070b!important}"
            "body:before{content:'';position:fixed;inset:0;pointer-events:none;background:repeating-linear-gradient(90deg,rgba(255,255,255,.022) 0 1px,transparent 1px 64px),repeating-linear-gradient(0deg,rgba(255,255,255,.016) 0 1px,transparent 1px 64px);opacity:.34}"
            "body:after{display:none}"
            ".geo,.nodefield{display:none}"
            ".card{position:relative;width:min(940px,calc(100vw - 22px))!important;max-height:calc(100vh - 22px)!important;border-radius:18px!important;background:#0b0b10!important;border:1px solid rgba(139,92,246,.34)!important;box-shadow:0 26px 72px rgba(0,0,0,.58)!important;animation:dx-in .24s cubic-bezier(.4,0,.2,1) both;overflow:hidden!important;display:flex;flex-direction:column}"
            ...
            ".coremark:before{content:'';position:absolute;left:12px;right:12px;top:11px;height:3px;background:#8b5cf6;box-shadow:0 10px 0 rgba(139,92,246,.66),0 20px 0 rgba(139,92,246,.38)}"
            ...
            ".tabs{display:grid!important;grid-template-columns:1fr 1fr;background:#09090d;border:1px solid rgba(139,92,246,.22);border-radius:12px;padding:6px;gap:6px!important}.tab{border-radius:9px!important;border:1px solid transparent!important;background:transparent!important;text-transform:uppercase;letter-spacing:.1em;font-weight:900}.tab.on{background:#8b5cf6!important;border-color:rgba(255,255,255,.18)!important;box-shadow:0 8px 20px rgba(76,29,149,.24)!important;color:#fff!important}"
            ".connbox{min-height:360px!important;border:1px solid rgba(139,92,246,.22)!important;border-radius:14px!important;background:#09090d!important;padding:18px!important;overflow:hidden!important}"
            ...
            ".connbox{background:#09090d!important}.card:after{background:rgba(139,92,246,.48)!important}.card,.pane.on{animation-duration:.18s!important}.coremark:before{animation:none!important;box-shadow:0 10px 0 rgba(139,92,246,.66),0 20px 0 rgba(139,92,246,.38)!important}.tab.on,#human_btn,button{box-shadow:0 8px 20px rgba(76,29,149,.24)!important}@media(prefers-reduced-motion:reduce){*,*:before,*:after{animation:none!important;transition:none!important}}"
