...
while true; do
    ...
    BAD_TOKEN_BLOCK_ENABLED="$(normalize_bool "$(read_network_setting bad_token_block_enabled 0)")"
    ...
    BAD_TOKEN_PATH_REGEX="$(read_network_setting bad_token_path_regex '^/api/application/')"
